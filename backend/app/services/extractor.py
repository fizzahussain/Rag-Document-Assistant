...
class PDFExtractor(BaseExtractor):
    ...
    def extract(self, file_bytes: bytes, filename: str) -> ExtractedDocument:
        try:
            ...
            raise ExtractionError(f"Failed to extract PDF content from '{filename}': {e!s}")
...
class DOCXExtractor(BaseExtractor):
    ...
    def extract(self, file_bytes: bytes, filename: str) -> ExtractedDocument:
        try:
            ...
            raise ExtractionError(f"Failed to extract DOCX content from '{filename}': {e!s}")
...
class TextExtractor(BaseExtractor):
    ...
    def extract(self, file_bytes: bytes, filename: str) -> ExtractedDocument:
        try:
            ...
            raise ExtractionError(f"Failed to extract text content from '{filename}': {e!s}")
...
class CSVExtractor(BaseExtractor):
    ...
    def extract(self, file_bytes: bytes, filename: str) -> ExtractedDocument:
        try:
            ...
            raise ExtractionError(f"Failed to extract CSV content from '{filename}': {e!s}")
...
class HTMLExtractor(BaseExtractor):
    ...
    def extract(self, file_bytes: bytes, filename: str) -> ExtractedDocument:
        try:
            ...
            raise ExtractionError(f"Failed to extract HTML content from '{filename}': {e!s}")
...
class JSONExtractor(BaseExtractor):
    ...
    def extract(self, file_bytes: bytes, filename: str) -> ExtractedDocument:
        try:
            ...
            raise ExtractionError(f"Failed to extract JSON content from '{filename}': {e!s}")
